...
public class AddJobCommandParser implements Parser<AddJobCommand> {
    ...
    public AddJobCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_JOB_TITLE, PREFIX_JOB_COMPANY, PREFIX_JOB_ROUNDS, PREFIX_JOB_SKILLS,
                PREFIX_JOB_ADDRESS, PREFIX_EMPLOYMENT_TYPE) || !argMultimap.getPreamble().isEmpty()) {
