...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        return new Person[] {
                ...
                new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                        new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new School("NUS"),
                        new Degree("Information Systems"), getTagSet("Flutter", "JavaScript")),
                ...
                new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                        new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new School("NTU"),
                        new Degree("Mathematics"), getTagSet("Java")),
                new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                        new Address("Blk 47 Tampines Street 20, #17-35"), new School("SMU"), new Degree("Business"),
                        getTagSet("Clang")),
    ...
    public static Job[] getSampleJobs() {
        return new Job[] { new Job(new JobTitle("Software Engineer"), new CompanyName("Google"), new JobRounds(5)),
                ...
                new Job(new JobTitle("Full Stack Developer"), new CompanyName("Netflix"), new JobRounds(4)) };
    }
