...
public class VersionTest {
    ...
    public void versionConstructor_correctParameter_valueAsExpected() {
        ...
        assertEquals(19, version.getMajor()); // Implicit accessor for Java records
        assertEquals(10, version.getMinor()); // Implicit accessor for Java records
        assertEquals(20, version.getPatch()); // Implicit accessor for Java records
