...
public class AddCommandParserTest {
        ...
        public void parse_allFieldsPresent_success() {
                ...
                assertParseSuccess(parser,
                                PREAMBLE_WHITESPACE + NAME_DESC_BOB + SCHOOL_DESC_BOB + DEGREE_DESC_BOB + PHONE_DESC_BOB
        ...
        public void parse_repeatedNonTagValue_failure() {
                ...
                assertParseFailure(parser, validExpectedPersonString + PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY
                                + ADDRESS_DESC_AMY + SCHOOL_DESC_AMY + DEGREE_DESC_AMY + validExpectedPersonString,
                                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME, PREFIX_ADDRESS, PREFIX_EMAIL,
                                                PREFIX_PHONE, PREFIX_SCHOOL, PREFIX_DEGREE));
        ...
        public void parse_optionalFieldsMissing_success() {
                ...
                assertParseSuccess(parser, NAME_DESC_AMY + SCHOOL_DESC_AMY + DEGREE_DESC_AMY + PHONE_DESC_AMY
        ...
        public void parse_invalidValue_failure() {
                ...
                // invalid phone
                assertParseFailure(parser,
                                NAME_DESC_BOB + SCHOOL_DESC_BOB + DEGREE_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB
                                                + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                                Phone.MESSAGE_CONSTRAINTS);

                // invalid email
                assertParseFailure(parser,
                                NAME_DESC_BOB + SCHOOL_DESC_BOB + DEGREE_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC
                                                + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                ...
                // non-empty preamble
                assertParseFailure(parser,
                                PREAMBLE_NON_EMPTY + NAME_DESC_BOB + SCHOOL_DESC_BOB + DEGREE_DESC_BOB + PHONE_DESC_BOB
