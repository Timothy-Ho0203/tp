...
public class TypicalPersons {
    ...
    // Duplicate with Phone to test robustness too.
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline").withSchool("NUS")
            ...
            .withEmail("alice@example.com").withPhone("94351253").withPhone("94351253").withPhone("94351253")
            .withTags("friends").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier").withSchool("NTU")
            .withDegree("Business Analytics").withAddress("311, Clementi Ave 2, #02-25").withEmail("johnd@example.com")
            .withPhone("98765432").withDegree("Business Analytics").withTags("owesMoney", "friends").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withSchool("SMU")
            .withDegree("Mathematics").withAddress("wall street").withPhone("95352563").withEmail("heinz@example.com")
            .build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withSchool("SIM")
            .withDegree("Physics").withAddress("10th street").withPhone("87652533").withEmail("cornelia@example.com")
            .withTags("friends").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withSchool("SIT")
            .withDegree("Accounting").withAddress("michegan ave").withPhone("9482224").withEmail("werner@example.com")
            .build();
    ...
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withSchool(VALID_SCHOOL_BOB)
            ...
            .withAddress(VALID_ADDRESS_BOB).withSchool(VALID_SCHOOL_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND)
            .build();
    ...
    public static final Job PRODUCT_MANAGER_APPLE = new Job(new JobTitle("Product Manager"), new CompanyName("Apple"),
            new JobRounds(3));

    public static final Job UX_DESIGNER_META = new Job(new JobTitle("UX Designer"), new CompanyName("Meta"),
            new JobRounds(3));

    public static final Job DEVOPS_ENGINEER_AMAZON = new Job(new JobTitle("DevOps Engineer"), new CompanyName("Amazon"),
            new JobRounds(4));
